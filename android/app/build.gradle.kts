...
android { namespace = "com.cashier.lebanon.pro"; compileSdk = flutter.compileSdkVersion; ndkVersion = flutter.ndkVersion
 defaultConfig { applicationId = "com.cashier.lebanon.pro"; minSdk = 23; targetSdk = flutter.targetSdkVersion; versionCode = flutter.versionCode; versionName = flutter.versionName }
